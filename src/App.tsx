  ...
  function downloadProxyConfigs(kind: "xray" | "singbox" | "clash_yaml" | "clash_json"): void {
    ...
    if (kind === "singbox") {
      ...
      downloadBlob(
        ...
        `MM-TH_sing-box_${proto}_${ts}.json`,
      );
      return;
    }
    ...
    <div className="ui-root">
      ...
      <div className="page-wrap">
        ...
        >
          <div>
            <div className="brand-row">
              <img className="brand-mark" src="/icon.svg" alt="MM-TH" />
              <p className="eyebrow">MM-TH</p>
            </div>
            <h1>
            ...
            <div className="summary-card">
              ...
              <div className="summary-actions">
                ...
                <button
                  ...
                  type="button"
                  onClick={() =>
                    exportValidIps("txt", "last", "MM-TH_valid_ips_last")
                  }
                >
                  Export Valid (TXT)
                </button>
                <button
                  ...
                  type="button"
                  onClick={() =>
                    exportValidIps("xlsx", "last", "MM-TH_valid_ips_last")
                  }
                >
                  Export Valid (XLSX)
                </button>
                ...
                <article className="export-card">
                  ...
                  <div className="export-actions">
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        exportValidIps("txt", "all", "MM-TH_valid_ips_all")
                      }
                    >
                      TXT
                    </button>
                ...
                <article className="export-card">
                  ...
                  <div className="export-actions">
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        exportCapabilityIpsTxt("cdn", "MM-TH_cdn_ips_last")
                      }
                    >
                      CDN TXT
                    </button>
                    ...
                    <button
                      ...
                      onClick={() =>
                        exportCapabilityIpsTxt(
                          "warp",
                          "MM-TH_warp_tcp_heuristic_ips_last",
                        )
                      }
                    >
                      WARP* TXT
                    ...
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        exportCapabilityIpsTxt("bpb", "MM-TH_bpb_ips_last")
                      }
                    >
                      BPB TXT
                    </button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      downloadBlob(
                        ...
                        `MM-TH_vless_uris_${new Date().toISOString().replace(/[:.]/g, "-")}.txt`,
                      );
                    }}
                  >
                    Export URIs (TXT)
        ...
        <footer className="footer">
          ...
          <a href="https://www.facebook.com/share/1Qj7H6i5g5/" target="_blank" rel="noreferrer">
            Facebook
          </a>
        </footer>
      </div>
